...
#include "levels/hmc/Pipe2/geo.inc.c"
#include "levels/hmc/Pine1/geo.inc.c"

#include "levels/hmc/Platform_1/geo.inc.c"
#include "levels/hmc/Cloud1/geo.inc.c"
#include "levels/hmc/Mplatform/geo.inc.c"