...
#include "levels/ccm/ClearPine/geo.inc.c"
#include "levels/ccm/SnowPine/geo.inc.c"
#include "levels/ccm/Iceplatform1/geo.inc.c"
#include "levels/ccm/SSLog/geo.inc.c"
#include "levels/ccm/Platform_2/geo.inc.c"
#include "levels/ccm/Stone2/geo.inc.c"