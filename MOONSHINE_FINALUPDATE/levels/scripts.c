...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MARIO_SUB,               mario_sub_geo),
...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BEE, Bee_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MOLINE, Moline_geo),
    LOAD_MODEL_FROM_GEO(MODEL_GOOMBONE, goombone_geo),
    RETURN(),
};
