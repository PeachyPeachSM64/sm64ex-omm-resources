...
DEFINE_COURSE(COURSE_BOB, 0x21202240) // (1)  Bob Omb Battlefield
DEFINE_COURSE(COURSE_WF, 0x04144440) // (2)  Whomp's Fortress
...
DEFINE_COURSE(COURSE_HMC, 0x12010040) // (6)  Hazy Maze Cave
