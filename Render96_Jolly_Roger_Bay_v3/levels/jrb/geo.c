...
#include "levels/jrb/JollyChad/geo.inc.c"
#include "levels/jrb/newjollyrock/geo.inc.c"
#include "levels/jrb/fallnew/geo.inc.c"
#include "levels/jrb/basenew/geo.inc.c"
#include "levels/jrb/newShip/geo.inc.c"
#include "levels/jrb/newbox/geo.inc.c"